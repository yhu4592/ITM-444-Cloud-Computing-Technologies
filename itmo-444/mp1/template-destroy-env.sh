...
aws s3api list-objects-v2 --bucket ykh-itmo-raw --query 'Contents[*].Key'
...
aws s3api delete-object --bucket ykh-itmo-raw --key $FILENAME

# https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3api/delete-bucket.html
aws s3api delete-bucket --buket ykh-itmo-raw
